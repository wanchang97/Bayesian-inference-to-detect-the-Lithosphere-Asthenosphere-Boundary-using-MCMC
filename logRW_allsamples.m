function [M_all,M_accepted,lnL,acc] = logRW_allsamples(logpiPdf,loglikelihood,m0,nRW,sigmam,fwd)
%{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch fwd.mtype
    case 0
        ...
        for i = 2:nRW
            ...
            u = unifrnd(0,1,1);
            u = log(u);
            D_candidate(i,:)=d_candidate; % store all proposals
    ...
    case 1
        ...
        D = zeros(nRW,k,1);
        B_candidate = zeros(nRW,k-1,nsd-1);
        D_candidate = zeros(nRW,k,1);
        B(1,:) = b0;
        D(1,:) = d0;
        ...
        for i = 2:nRW
            ...
            u = unifrnd(0,1,1);
            u = log(u);
            B_candidate(i,:) = b_candidate;
            D_candidate(i,:) = d_candidate;
            if u <= alpha % accept the sample
                B(i,:) = b_candidate;
                D(i,:) = d_candidate;
                acc = acc + 1;
