...
fileName_TraceHist = ['Histogram and trace plot with np = ' num2str(fwd.np) ' sigmaRratio = ' num2str(sigmaRratio) ' sigmaObratio = ' num2str(sigmaObratio) '_sigmaRWratio = ' num2str(sigmaRWratio,'%.4f')  ' and n = ' num2str(nRW) '.png'];
