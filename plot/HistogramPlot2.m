function HistogramPlot2(M,true_m,delta,error_m,nburn,n,m,acc,figurepath,fwd,stringinput,sigmam,sigmaObratio,fileName,priorInfo)
% This histogram only plots the steady state histogram, not including the
% prior distribution
fig = figure;
k = fwd.k;
switch fwd.mtype
