...
sensorExactLocations = ...
    ...
    fwd.geometry.lx*18/24,   fwd.geometry.lz*13/20  ; ...
...
fileName_TraceHist = ['Histogram plot and trace plot with np = ' num2str(fwd.np) ' sigmaRratio = ' num2str(sigmaRratio) ' sigmaObratio = ' num2str(sigmaObratio) '_sigmaRWratio = ' num2str(sigmaRWratio)  ' and n = ' num2str(nRW) '.png'];
TraceHistogramPlot(MRW,true_m,delta,m0,figurepath,fwd,fileName_TraceHist)
%% Trace plot
fileName_Trace = ['Markov Chain states plot np = ' num2str(fwd.np) ' sigmaRratio = ' num2str(sigmaRratio) ' sigmaObRatio = ' num2str(sigmaObratio) '_sigmaRWatio = ' num2str(sigmaRWratio) ' and n = ' num2str(nRW) '.png'];
...
fileName = ['Scatter plot of steady MCMC samples (without burn-in periods np = ' num2str(fwd.np) ' sigmaRratio = ' num2str(sigmaRratio) ' sigmaObratio = ' num2str(sigmaObratio) '_sigmaRWratio = ' num2str(sigmaRWratio) ' and nRW = ' num2str(nRW) '.png'];
