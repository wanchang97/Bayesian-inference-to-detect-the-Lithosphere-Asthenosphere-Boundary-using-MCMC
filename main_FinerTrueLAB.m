...
switch  fwd.mtype
    case 0
        true_d = fwd.geometry.lz*[1/3;1/2;2/5;1/4];   
        fwd.nm = k;
        true_m = true_d;
        figurepath = ['FinerTrueLAB_figures_truek=' num2str(k) '/regularGrids'];
        stringinput = {};
        for i = 1:k
    ...
    case 1
        true_b = fwd.geometry.lx*[3/24;2/24;4/24;2/24;3/24;4/24;2/24];
        true_d = fwd.geometry.lz*[1/3;1/4;1/2;5/12;2/5;3/5;1/5;1/4];   
        fwd.nm = k+(k-1)*(fwd.nsd-1);
        true_m = [true_b; true_d];
        figurepath = ['FinerTrueLAB_figures_truek=' num2str(truek) '/irregularGrids'];
        stringinput = {};
        for i = 1:k-1
...
%% Random Walk sampler
nRW = 10000;
%nRW = 20000; % first 1000 burn in and second 1000
...
%sigmaRWratio_b = 1/120; sigmaRWratio_d = 1/200;
sigmaRWratio_d = 1/100;% 1/150; 1/120; 
switch fwd.mtype
    case 0
